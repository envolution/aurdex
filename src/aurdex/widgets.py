...
class PackageDetails(VerticalScroll):
    ...
    def update_package(
        ...
        content_parts.append(
            f"[b $accent]PackageBase:[/] [$text]{package.get('package_base', '[dim]Unknown[/dim]') or '[dim]Unknown[/dim]'}[/$text]\n"
        )
        ...
        content_parts.append(
            f"[b $accent]Submitter:[/] [$text]{submitter or '[dim]Not specified[/dim]'}[/$text]\n"
        )
